            ...
            <div class="m-0 px-lg-5 p-0">
              <div class="container-fluid px-lg-5 p-5 text-center">
                  ...
                  <div class="row px-lg-5 " id="new_donees_user">
                      <?php
                      $sql = "SELECT * FROM abuloy_accounts WHERE uid = $uid AND account_status = 1 ORDER BY id DESC";
                  ...
                  <div class="row px-lg-5 hide" id="old_donees_user">
                      <?php
                      $sql = "SELECT * FROM abuloy_accounts WHERE uid = $uid AND account_status = 1 ORDER BY id ASC";
                      $result = $mysqli->query($sql);
                      while($account = $result->fetch_assoc()){
                          $aid = $account['id'];
                          $uid = $account['uid'];
                  ...
                  <div class="row px-lg-5 hide" id="filter_donees_user">
                      <?php
                      $sql = "SELECT * FROM abuloy_accounts WHERE uid = $uid AND d_firstname LIKE '{$input}%'";
                      $result = $mysqli->query($sql);
                      while($account = $result->fetch_assoc()){
                          $aid = $account['id'];
                          $uid = $account['uid'];
          ...
          <div class="row banner-content fullscreen align-items-center justify-content-start pb-4">
              <div class=" col-lg-7 col-md-6 col-sm-12 p-0 mb-4">
                  <div class="col-lg-12 pt-5 ps-5">
                      ...
                      <div class="pe-5 pt-0"><h4 class="pe-5 pt-0 mt-0">I'm Sorry! You need to register first to gain access on this page</h4></div>
