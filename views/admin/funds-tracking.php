...
<body>
    ...
    <section class="py-5 my-3">
        <div class="container">
            <legend class="pt-5 pb-0 text-lavander">Funds Tracking</legend>
            <hr class="m-0 p-0">
            <div class="mt-3">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#paid">Paid</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#refund">Refund</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#expired">Expired</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#cancelled">Cancelled</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#withdraw">Withdraw</a>
                    </li>
                </ul>
                <div class="tab-content">                    
                    <div class="tab-pane fade show table-responsive" id="all">
                        <table class="table table-borderless table-striped table-condensed">
                            ...
                            <tbody>
                                <?php 
                                    $all_funds_qry = $mysqli->prepare("SELECT * FROM abuloy_payments");
                    ...
                    <div class="tab-pane fade table-responsive" id="paid">
                        <table class="table table-borderless table-striped table-condensed">
                            <thead>
                                <th>#</th>
                                <th>Account Name</th>
                            ...
                            <tbody>
                                <?php 
                                    $all_funds_qry = $mysqli->prepare("SELECT * FROM abuloy_payments WHERE payment_status = 1");
                                    $result_all_funds = $all_funds_qry->execute();
                                    $result_all_funds = $all_funds_qry->get_result();
                                    while($all_funds = $result_all_funds->fetch_assoc()){
                                    $i=1;
                    ...
                    <div class="tab-pane fade table-responsive" id="refund">
                        <table class="table table-borderless table-striped table-condensed">
                            <thead>
                                <th>#</th>
                                <th>Account Name</th>
                            ...
                            <tbody>
                                <?php 
                                    $all_funds_qry = $mysqli->prepare("SELECT * FROM abuloy_payments WHERE payment_status = 2");
                                    $result_all_funds = $all_funds_qry->execute();
                                    $result_all_funds = $all_funds_qry->get_result();
                                    while($all_funds = $result_all_funds->fetch_assoc()){
                                    $i=1;
                    ...
                    <div class="tab-pane fade table-responsive" id="expired">
                        <table class="table table-borderless table-striped table-condensed">
                            <thead>
                                <th>#</th>
                                <th>Account Name</th>
                            ...
                            <tbody>
                                <?php 
                                    $all_funds_qry = $mysqli->prepare("SELECT * FROM abuloy_payments WHERE payment_status = 3");
                                    $result_all_funds = $all_funds_qry->execute();
                                    $result_all_funds = $all_funds_qry->get_result();
                                    while($all_funds = $result_all_funds->fetch_assoc()){
                                    $i=1;
                    ...
                    <div class="tab-pane fade table-responsive" id="cancelled">
                        <table class="table table-borderless table-striped table-condensed">
                            <thead>
                                <th>#</th>
                                <th>Account Name</th>
                            ...
                            <tbody>
                                <?php 
                                    $all_funds_qry = $mysqli->prepare("SELECT * FROM abuloy_payments WHERE payment_status = 4");
                                    $result_all_funds = $all_funds_qry->execute();
                                    $result_all_funds = $all_funds_qry->get_result();
                                    while($all_funds = $result_all_funds->fetch_assoc()){
                                    $i=1;
                    ...
                    <div class="tab-pane fade table-responsive" id="withdraw">
                        <table class="table table-borderless table-striped table-condensed">
                            <thead>
                                <th>#</th>
                                <th>Account Name</th>
                            ...
                            <tbody>
                                <?php 
                                    $all_funds_qry = $mysqli->prepare("SELECT * FROM abuloy_payments WHERE payment_status = 5");
                                    $result_all_funds = $all_funds_qry->execute();
                                    $result_all_funds = $all_funds_qry->get_result();
                                    while($all_funds = $result_all_funds->fetch_assoc()){
                                    $i=1;
    ...
    <!-- Custom Script -->
    <script src="../controllers/funds-tracking.js"></script>
</body>
</html>