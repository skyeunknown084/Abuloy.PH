            ...
            <div class="row" id="donate_user">
                ...
                <div class="col-lg-7 ps-lg-5 donate_user_search">
                    ...
                    <p class="no-mobile-donate-photo">
                        ...
                        <?php }else{ ?>
                            <img src="<?= 'https://abuloy.ph/assets/uploads/'.$photo ?>" alt="" class="donate-photo" style="width:70%; height: 580px; object-fit: scale-down">
                        <?php } ?>
                        </a>
                        </p>
                        ...
                        <?php }else{ ?>
                            <img src="<?= 'https://abuloy.ph/assets/uploads/'.$photo ?>" alt="" style="width:100%; height: 360px; object-fit: contain">
                        <?php } ?>
                        </a>
                        </p>
                        <legend class="text-blackish fw-bold text-center pb-0 mb-0" x="42%" y="90%"><?= ucfirst($fname) ?> <?php if($mname != ''){ echo ucfirst($mname[0]). "."; }else{ echo ucfirst($mname); } ?> <?= ucfirst($lname) ?></legend>
                    ...
                    <div class="accordion-item bg-white shadow-sm">
                        <div class="accordion-button bg-aquamarine text-blackish" id="panelsStayOpen-headingOne">
                            <button class="bg-aquamarine text-purple fw-bold" type="button">
                                <?php 
                                $num_donators = $mysqli->query("SELECT * FROM abuloy_payments WHERE aid = $aid AND payment_status = 1")->num_rows; ?>
