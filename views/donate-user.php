...
echo $aid;
if(isset($aid)){
    $acct_qry = "SELECT * FROM abuloy_users WHERE id = $aid";
                        ...
                        <div class="card-body py-4">                            
                            <form action="" id="process_payment" method="POST">
                                ...
                                <div class="col-12 d-flex">
                                    ...
                                    <a href="https://www.paypal.com/donate/?hosted_button_id=RW46D3593NK74" target="_blank" class="col-lg-4 col-md-6 col-sm-12"><img src="http://localhost/assets/img/paypal.png" alt="" height="25px" class="text-center align-center mx-auto pe-2"></a>
                                </div>
                                </div>
