...
<div class="container py-5">
    <div class="row banner-content fullscreen align-items-center justify-content-start pb-4">
        <div class=" col-lg-12 col-md-12 col-sm-12 p-0 mb-4">
            <div class="col-lg-12 pt-5 ps-lg-0 ps-md-0 ps-5">
                <h1 class="display-1 align-left"><div class="fw-900 pb-4"><span class="text-aquamarine">/</span><span class="text-lavander">a·bú·loy</span></div></h1>
                <div class="pe-5 pt-0"><h3 class="pe-5 pt-0 mt-0">financial assistance given to someone in need at/for a funeral;</h3></div>
                <div class="pe-5 pt-0">
                    <h3 class="pe-5 pt-0 mt-0">
                        <a href="" class="typewrite no-style text-blackish" data-period="2000" data-type='[ "to aid;", "to contribute;", "to donate;" ]'>
                            <span class="wrap"></span>
                        </a>
                    </h3>
                </div>
                <!-- <div class="col-lg-4 justify-content-start typewriter"><h2>to&nbsp;donate;</h2></div> -->
                <!-- to contribute; to aid; -->
                <br/><br/>
                <div class="ps-lg-0 ps-md-0 ps-4">
...
<div class="w-auto">
    <iframe class="dashboard-video-frame" style="width:100%;height:100vh" src="https://www.youtube.com/embed/82iex8AJ0ww" title="Abuloy.PH Explainer Video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
<div class="container py-5 px-5">
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 pb-3">
            <div style="font-size:24px"><strong class="text-uppercase text-lavander">Register</strong></div>
            <p>Complete our simple registration form.</p>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 pb-3">
            <div style="font-size:24px"><strong class="text-uppercase text-lavander">Share</strong></div>
            <p>Share the link to your client's family and friends.</p>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 pb-3">
            <div style="font-size:24px"><strong class="text-uppercase text-lavander">Receive</strong></div>
