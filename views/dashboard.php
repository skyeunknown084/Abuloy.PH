        ...
        <div class="row banner-content fullscreen align-items-center justify-content-start pb-4">
            <div class=" col-lg-12 col-md-12 col-sm-12 p-0 mb-4">
                <div class="col-lg-12 pt-5 ps-5">
                    ...
                    <a href="" class="typewrite no-style text-lavander" data-period="2000" data-type='[ "to donate;", "to contribute;", "to aid;" ]' style="font-size:24px;font-weight:500">
                        <span class="wrap"></span>
                    </a>
                    <!-- <div class="col-lg-4 justify-content-start typewriter"><h2>to&nbsp;donate;</h2></div> -->
                    <!-- to contribute; to aid; -->
                    <br/><br/>
                    <div class="pe-5 pt-0"><h4 class="pe-5 pt-0 mt-0">Making It Easy to Give an Abuloy</h4></div>
