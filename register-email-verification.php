<?php
    ...
    function sendEmailVerification($token, $otp, $email, $firstname) {
        require "global_call.php";
        ...
        <table style='width:50vw'>
            ...
            <tr>
                <td style='width:100vh;margin:2% 0;'><div style='margin-top:25px;text-align:left;width:100vh;'>Hi $firstname,<br/><br/>We are delighted that you signed up for Abuloy PH.<br/>To start building a fund for your love ones, please click the button below to fully verify.</div></td>
            </tr>
            <tr><td><br/><br/><div style='margin-top:25px;display:none;visibility:hidden'>Your Code:<div></td></tr>
            <tr><td><a href='http://abuloy.ph/register-update-verification/$token' style='height:50px;border-radius:25px;background-color:#A265E6;color:#94F7CF;padding:8px 15px;text-align:center;font-weight:600;font-family:Poppins;text-decoration:none;'> Verify Account </a></td></tr>
    ...
    <section class="my-5" style="height:60vh">
        <div class="container otp-container my-5 pt-2">
            <div class="col-lg-6 col-md-6 col-sm-12 text-center mx-auto mt-5">
                <legend class="text-lavander my-0 py-0">Email Verification Sent!</legend>
                <small class="text-blackish">To complete your registration please check your email inbox or spam message and click the button provided in the email to fully verify.</small>
                <br/><br/>
